export const en = {
  ...
  products: {
    ace: "Ace 500mg Tablet",
    cef3: "Cef-3 200mg Tablet",
    cerelac: "Cerelac Wheat 400g",
    dove: "Dove Shampoo 340ml",
  ...
  demo: {
    ...
    subtitle:
      "Add real store items, pick Cash, bKash or Card, and check out. Then open the live production POS to run the same sale with barcode scanning, receipt printing and ledger sync.",
    terminal: "Tech BitePOS · Agrabad Branch · Till 02",
    launch: "Launch Full Live POS App",
    inStock: "{n} in stock",
    ...
    journal: {
      ...
      drCard: "Dr Card Settlement (Bank)",
      crSales: "Cr Sales Revenue",
      balanced: "Balanced · posted to ledger",
    },
    newSale: "New sale",
    modal: {
      title: "Proceed to Live Production POS",
      body: "Experience real-time barcode scanning, receipt printing, and ledger sync on our live demo branch.",
      cta: "Open Real POS Terminal (Agrabad Branch)",
      local: "Print a demo receipt here instead",
      close: "Close",
      items: "{n} items",
    },
  },
